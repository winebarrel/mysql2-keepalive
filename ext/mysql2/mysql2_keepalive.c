...
void Init_keepalive() {
  ...
  // TCP_KEEPINTVL
  rb_define_module_function(rb_cMysql2Client, "keepintvl", rb_mysql2_client_get_keepintvl, 1);
  rb_define_module_function(rb_cMysql2Client, "keepintvl=", rb_mysql2_client_set_keepintvl, 2);
}
